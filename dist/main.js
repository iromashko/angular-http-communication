...
module.exports = __webpack_require__(/*! /home/iromashko/develop/angular-http-communication/src/main.ts */"zUnb");
...
let AddBookComponent = class AddBookComponent {
    ...
    saveBook(formValues) {
        ...
        this.dataService
            .addBook(newBook)
            .subscribe((data) => console.log(data), console.log);
    }
};
...
let EditBookComponent = class EditBookComponent {
    ...
    ngOnInit() {
        ...
        this.dataService.getBookById(bookID).subscribe((data) => (this.selectedBook = data), console.log, () => console.log("Get book done"));
        this.dataService
    ...
    saveChanges() {
        this.dataService
            ...
            .subscribe((data) => console.log(`${this.selectedBook.title} updated successfully.`), console.log);
    }
};
...
let DataService = class DataService {
    ...
    getAllBooks() {
        return this.http
            .get("/api/books")
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])((err) => this.handleHttpError(err)));
    }
    ...
    getOldBookById(id) {
        return this.http.get(`/api/books/${id}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])((book) => ({
            bookTitle: book.title,
            year: book.publicationYear,
        })), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(console.log));
    }
    addBook(newBook) {
    ...
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        providers: [
            ...
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HTTP_INTERCEPTORS"], useClass: _core_add_header_interceptor__WEBPACK_IMPORTED_MODULE_13__["AddHeaderInterceptor"], multi: true },
            {
                ...
                useClass: _core_log_response_interceptor__WEBPACK_IMPORTED_MODULE_14__["LogResponseInterceptor"],
                multi: true,
            },
        ],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"]],
...
/* harmony import */ var _http_cache_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./http-cache.service */ "7M7W");
...
CacheInterceptor.ctorParameters = () => [
    { type: _http_cache_service__WEBPACK_IMPORTED_MODULE_5__["HttpCacheService"] }
];
...
const routes = [
    {
        path: "dashboard",
        component: app_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_5__["DashboardComponent"],
        resolve: {
            resolvedBooks: _core_books_resolver_service__WEBPACK_IMPORTED_MODULE_8__["BooksResolverService"],
        },
    },
